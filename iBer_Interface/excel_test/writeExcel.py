...
class Write_excel(object):
    '''修改excel数据'''
    excel_path = "/Users/lucky/Desktop/Auto/iBer_Python_Interface/iBer_Interface/excel_test/"
    copy_excel(excel_path+"lucky_excel_test.xlsx", excel_path+"testreport.xlsx")
